...
public class CRUDmanhinh extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        tblHinh.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Id", "Mã MH", "Tên MH", "Ngày Tạo", "Ngày Sửa", "Trạng Thái"
            }
        ));
    ...
    private void btn_suaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_suaActionPerformed
        ...
        if (cf == JOptionPane.YES_OPTION) {
            JOptionPane.showMessageDialog(this, mS.update(getFieldUpdate()));
            fillTable(mS.getListManHinh());
    ...
    private void btn_xoaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_xoaActionPerformed
        ...
        if (cf == JOptionPane.YES_OPTION) {
            JOptionPane.showMessageDialog(this, mS.delete(txt_ma.getText().trim()));
            fillTable(mS.getListManHinh());
            btn_them.setEnabled(true);
            btn_sua.setEnabled(false);
            btn_xoa.setEnabled(false);
    ...
    private void tblHinhMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblHinhMouseClicked
        ...
        txt_ma.setText(tblHinh.getValueAt(index, 1).toString());
    ...
    private void btn_themActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_themActionPerformed
        ...
        if (cf == JOptionPane.YES_OPTION) {
            JOptionPane.showMessageDialog(this, mS.insert(getFieldInsert()));
            fillTable(mS.getListManHinh());
        }
    ...
    private ManHinh getFieldInsert() {
        LocalDate date = LocalDate.now();
        ManHinh mH = new ManHinh();
        mH.setMa(txt_ma.getText().trim());
        mH.setTen(txtTen.getText().trim());
        mH.setNgayTao(date.format(DateTimeFormatter.ISO_DATE));
        mH.setNgayNhap(date.format(DateTimeFormatter.ISO_DATE));
    ...
    private ManHinh getFieldUpdate() {
        LocalDate date = LocalDate.now();
        ManHinh mH = new ManHinh();
        mH.setMa(txt_ma.getText().trim());
        mH.setTen(txtTen.getText().trim());
