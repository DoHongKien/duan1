...
public class CRUDhang extends javax.swing.JFrame {
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18)
                        .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(btn_moi, javax.swing.GroupLayout.PREFERRED_SIZE, 77, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void btn_suaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_suaActionPerformed
        ...
        if (cf == JOptionPane.YES_OPTION) {
            JOptionPane.showMessageDialog(this, hS.update(getFieldUpdate()));
            fillTable(hS.getListHang());
    ...
    private void btn_xoaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_xoaActionPerformed
        ...
        if (cf == JOptionPane.YES_OPTION) {
            JOptionPane.showMessageDialog(this, hS.delete(txt_ma.getText().trim()));
            fillTable(hS.getListHang());
            btn_them.setEnabled(true);
            btn_sua.setEnabled(false);
            btn_xoa.setEnabled(false);
    ...
    private void tblHangMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblHangMouseClicked
        ...
        txt_ma.setText(tblHang.getValueAt(index, 1).toString());
    ...
    private Hang getFieldInsert() {
        LocalDate date = LocalDate.now();
        Hang hG = new Hang();
        hG.setMa(txt_ma.getText().trim());
        hG.setTen(txtTen.getText().trim());
        hG.setNgayTao(date.format(DateTimeFormatter.ISO_DATE));
        hG.setNgayNhap(date.format(DateTimeFormatter.ISO_DATE));
